...
namespace Microsoft.Xna.Framework.Graphics
{
	...
	public class SpriteBatch : GraphicsResource
	{
        ...
        void CheckValid(SpriteFont spriteFont)
        {
            if (spriteFont == null)
        ...
        {
            ReadOnlySpan<char> span = text ?? throw new ArgumentNullException(nameof(text));
            DrawString(spriteFont, span, position, color);
        }
        ...
        {
            ReadOnlySpan<char> span = text ?? throw new ArgumentNullException(nameof(text));
            DrawString(spriteFont, span, position, color, rotation, origin, scale, effects, layerDepth);
        }
        ...
        {
            ReadOnlySpan<char> span = text ?? throw new ArgumentNullException(nameof(text));
            DrawString(spriteFont, span, position, color, rotation, origin, scale, effects, layerDepth, rtl);
        }
